...
public class SelectManager : MonoBehaviour
{
    ...
    public void deleteButton()                      // 캐릭터 삭제 버튼
    {
        if(DataManager.instance.deleteCreateInfo(GameManager.instance.m_iCreateCharacterIndex) == true) // 만약 삭제가 됬으면
            SceneManager.LoadScene("SelectCharacterScene");          // 씬 재로딩
    }
    ...
    public void selectButton0()                                                 // 선택창0 버튼
    {
        ...
        SceneManager.LoadScene("CreateCharacterScene");                                 // 슬롯 인덱스 0이 없으면 캐릭터 생성창으로 바꾼다.
    }
    ...
    public void selectButton1()                                                 // 선택창0 버튼
    {
        ...
        SceneManager.LoadScene("CreateCharacterScene");                                 // 슬롯 인덱스 1이 없으면 캐릭터 생성창으로 바꾼다.
    }
    ...
    public void selectButton2()                                                 // 선택창0 버튼
    {
        ...
        SceneManager.LoadScene("CreateCharacterScene");                                 // 슬롯 인덱스 2이 없으면 캐릭터 생성창으로 바꾼다.
    }
}
