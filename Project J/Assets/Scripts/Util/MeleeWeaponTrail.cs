...
{
    public GameObject m_parentObject;      // 부모가 될 오브젝트
	[SerializeField]
	bool _emit = true;
	...
	public float _minVertexDistanceSqr = 0.0f;
	...
	void Start()
	{
        ...
        m_parentObject = GameObject.Find("ObjectPoolManager").gameObject;        // 임시로 강제 연결

        _trailObject.transform.parent = m_parentObject.transform;         
